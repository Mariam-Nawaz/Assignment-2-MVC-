...
$(document).ready(function(){
    $("#mobile-menu-open1").click(function(){
        $("#mobile-menu-show1").toggleClass("mobile-show1").css({"transition": "all 0.7s ease"});
    });
    $("#mobile-menu-close1").click(function(){
        $("#mobile-menu-show1").toggleClass("mobile-show1").css({"transition": "all 0.3s ease"});
    });
    $("#mobile-menu-show1").mouseleave(function(){
        $("#mobile-menu-show1").css({"opacity": "0", "z-index": "-999", "width": "0"});
    });
    $("#mobile-menu-open1").click(function(){
        $("#mobile-menu-show1").css({"opacity": "1", "z-index": "999999", "width": "320px"});
    });
});
